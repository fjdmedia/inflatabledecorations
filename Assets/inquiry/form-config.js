...
window.FJ_FORM_CONFIG = {
  ...
  groups: [
    ...
    { legend: "Your event", fields: [
      ...
      { id: "setup", type: "text", label: "Setup hours needed before the event", required: true, placeholder: "e.g. 2" },
